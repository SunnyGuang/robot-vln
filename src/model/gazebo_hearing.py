...
if new_text:
    ...
    memory_file_path = '/home/sunny/catkin_ws/src/project/memory/gazebo_memory.csv'
    ...
    if not matched_object.empty:
        ...
        with sr.Microphone() as source:
            engine.say('Got it, please follow me')
            print("Got it, please follow me")
    else:
        # If no match is found, print a hint message
        with sr.Microphone() as source:
            engine.say('Sorry, I cannot find it in environment')
